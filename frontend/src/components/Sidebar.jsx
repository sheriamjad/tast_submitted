...
import { Box, Typography, List, ListItem, ListItemText, styled, Divider } from "@mui/material";
import { LightMode, DarkMode, Dashboard, Group, Business, Receipt, Settings } from "@mui/icons-material";
...
const Sidebar = ({ toggleTheme, isDark, activeItem }) => {
  return (
    <Box
      sx={{
        width: 250,
    ...
    >
      ...
      {/* Menu Section */}
      <List sx={{ mt: 1 }}> {/* Reduced margin above the menu */}
        {[
